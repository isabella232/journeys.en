...
| Category    | Function              |
|-------------|-----------------------|
| AEP         | [getBestSendTime](../../using/functions/functiongetbestsendtime.md)|
| AEP         | [inSegment](../../using/functions/functioninsegment.md)|
| Aggregation | [avg](../../using/functions/functionavg.md)|
| Aggregation | [count](../../using/functions/functioncount.md)|
| Aggregation | [countOnlyNull](../../using/functions/functioncountonlynull.md)|
| Aggregation | [countWithNull](../../using/functions/functioncountwithnull.md)|
| Aggregation | [discountCount](../../using/functions/functiondistinctcount.md)|
| Aggregation | [discountCountwithNull](../../using/functions/functiondistinctcountwithnull.md)|
| Aggregation | [max](../../using/functions/functionmax.md)|
| Aggregation | [min](../../using/functions/functionmax.md)|
| Aggregation | [sum](../../using/functions/functionsum.md)|
| Conversion  | [toBool](../../using/functions/functiontobool.md)|
| Conversion  | [toDateTime](../../using/functions/functiontodatetime.md)|
| Conversion  | [toDateTimeOnly](../../using/functions/functiontodatetimeonly.md)|
| Conversion  | [toDecimal](../../using/functions/functiontodecimal.md)|
| Conversion  | [toDuration](../../using/functions/functiontoduration.md)|
| Conversion  | [toInteger](../../using/functions/functiontointeger.md)|
| Conversion  | [toString](../../using/functions/functiontostring.md)|
| Conversion  | [toTimeZone](../../using/functions/functiontotimezone.md)|
| Date        | [currentTime​InMillis](../../using/functions/functioncurrenttimeinmillis.md)|
| Date        | [inLastDays](../../using/functions/functioninlastdays.md)|
| Date        | [inLastHours](../../using/functions/functioninlasthours.md)|
| Date        | [inLastMonths](../../using/functions/functioninlastmonths.md)|
| Date        | [inLastYears](../../using/functions/functioninlastyears.md)|
| Date        | [inNextDays](../../using/functions/functioninnextdays.md)|
| Date        | [inNextHours](../../using/functions/functioninnexthours.md)|
| Date        | [inNextMonths](../../using/functions/functioninnextmonths.md)|
| Date        | [inNextYears](../../using/functions/functioninnextyears.md)|
| Date        | [now](../../using/functions/functionnow.md)|
| Date        | [nowWithDelta](../../using/functions/functionnowwithdelta.md)|
| Date        | [setHours](../../using/functions/functionsethours.md)|
| Date        | [setDays](../../using/functions/functionsetdays.md)|
| Date        | [updateTimeZone](../../using/functions/functionupdatetimezone.md)|
| List        | [distinct](../../using/functions/functiondistinct.md)|
| List        | [distinctWithNull](../../using/functions/functiondistinctcount.md)|
| List        | [in](../../using/functions/functionin.md)|
| List        | [listSize](../../using/functions/functionlistsize.md)|
| List        | [serializeList](../../using/functions/functionserializelist.md)|
| List        | [sort](../../using/functions/functionsort.md)|
| Math        | [random](../../using/functions/functionrandom.md)|
| Math        | [round](../../using/functions/functionround.md)|
| String      | [concat](../../using/functions/functionconcat.md)|
| String      | [contain](../../using/functions/functioncontain.md)|
| String      | [containWithIgnoreCase](../../using/functions/functioncontainwithignorecase.md)|
| String      | [endWith](../../using/functions/functionendwith.md)|
| String      | [endWithIgnorecase](../../using/functions/functionendwithignorecase.md)|
| String      | [equalWithIgnoreCase](../../using/functions/functionequalignorecase.md)|
| String      | [indexOf](../../using/functions/functionindexof.md)|
| String      | [isEmpty](../../using/functions/functionisempty.md)|
| String      | [isNotEmpty](../../using/functions/functionisnotempty.md)|
| String      | [lastIndexOf](../../using/functions/functionlastindexof.md)|
| String      | [length](../../using/functions/functionlength.md)|
| String      | [lower](../../using/functions/functionlower.md)|
| String      | [matchRegExp](../../using/functions/functionmatchregexp.md)|
| String      | [notEqualWithIgnoreCase](../../using/functions/functionnotequalignorecase.md)|
| String      | [replace](../../using/functions/functionreplace.md)|
| String      | [replaceAll](../../using/functions/functionreplaceall.md)|
| String      | [startWith](../../using/functions/functionstartwith.md)|
| String      | [startWithIgnoreCase](../../using/functions/functionstartwithignorecase.md)|
| String      | [substr](../../using/functions/functionsubstr.md)|
| String      | [trim](../../using/functions/functiontrim.md)|
| String      | [upper](../../using/functions/functionupper.md)|
| String      | [uuid](../../using/functions/functionuuid.md)|
