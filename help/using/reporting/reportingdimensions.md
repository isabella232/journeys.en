...
Please note that if two components are not compatible, the cell will display the value **None**. To learn more on compatibility between dimensions and metrics, refer to this [table](help/using/assets/dynamic_report_compatibility_journey.pdf).
