...
1. Then, you can share the payload preview with to the person responsible for the event sending. This payload can help him design the setup of an event pushing to Triggered Journeys. See [Additional steps to send events to Journeys](eventsteps.dita#concept_xrz_n1q_y2b).
