...
|Math|is numeric|`<expression> is numeric`<p>The type of the expression is integer or decimal.</p>|@{BarBeacon.location} is numeric</p>|
|Math|is integer|`<expression> is integer`<p>The type of the expression is integer.</p>|@{BarBeacon.location} is integer</p>|
|Math|is decimal|`<expression> is decimal`<p>The type of the expression is decimal.</p>|@{BarBeacon.location} is decimal</p>|
