...
You can use the simple expression editor or the advanced expression editor to setup conditions on events. See [Using the advanced expression editor](../expression/expressionadvanced.md#concept_uyj_trt_52b).
