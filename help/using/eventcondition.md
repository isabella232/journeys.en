...
You can use the simple expression editor or the advanced expression editor to setup conditions on events. See [Building advanced conditions](expressionadvanced.md#concept_uyj_trt_52b).
