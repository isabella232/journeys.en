...
These activities represent the different available communication channels. You can combine them to create a cross-channel scenario. The following out-of-the-box action activities are available, if you have Adobe Campaign Standard: **Email**, **Push** and **SMS**. If you've configured custom actions, they will also appear here (see [Custom action configuration](../action/custom.md) and [Custom actions](../building-journeys/journeyactioncustom.md)).
