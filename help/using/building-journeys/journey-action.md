...
If you have Adobe Campaign Standard, the following out-of-the-box action activities are available: **Email**, **Push** and **SMS**. See [](../building-journeys/journey-action-campaign.md). 

If you've configured custom actions, they will also appear here (see [](../building-journeys/journey-action-custom.md)).
