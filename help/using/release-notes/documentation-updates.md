...
* A note has been added on the generation of reals events when triggering events using the test mode. [Read more](../building-journeys/testing-the-journey.md#firing_events)
