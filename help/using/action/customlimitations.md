...
* The built-in **Reaction** event allows you to react to out-of-the-box actions (see [](../building-journeys/journeyevent.md#concept_rws_1rt_52b)). If you want to react to a message sent via a custom action, you need to configure a dedicated event.
